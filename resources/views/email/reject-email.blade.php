...
<html>
  ...
  <body style="-webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;">
    <div style="padding: 1rem;">
        ...
        <h1 style="padding-left: 1.5rem; padding-right: 1.5rem; padding-top: 0.75rem; font-weight: 700; font-size: 1.875rem; line-height: 2.25rem;">Permintaan Akses Server Anda Telah Ditolak</h1>
        <p style="padding-left: 1.5rem; padding-right: 1.5rem; padding-top: 0.75rem;">Mohon maaf permintaan akses server anda dibawah ini telah ditolak.</p>
